                ...
                <div className="mb-4">
                     ...
                     <div className="flex gap-2">
                        <input 
                            ...
                            onChange={e => handleInputChange('formAccessKey', e.target.value)} 
                 ...
                 <div className={`border-t pt-4 mb-4 ${hasAccessKey ? 'opacity-60 bg-gray-50 p-3 rounded' : ''}`}>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                       Used only if no Access Key is provided above. Uses FormSubmit.co.
                    </p>
                </div>
